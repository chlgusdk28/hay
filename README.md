...
시연영상 https://youtu.be/IZ3aj1Av78E


간단한 시스템 구조도는 이슈에서 확인가능합니다.
(미리확인용입니다. 상세 내용은 안에 있는 pdf 내용으로 확인 가능합니다)

* 해당 깃 레지스토리는 본인 보관용이자 포폴용입니다.

히스토리는 공동작업 레지스토리 https://github.com/LMW940423/Android_Hay 여기서 확인 가능합니다. 
